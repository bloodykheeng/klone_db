    ...
    return (
        <div className="layout-topbar">
            <Link className="layout-topbar-logo">
                <img src={props.layoutColorMode === "light" ? "assets/klone_db_photos/klone-db-logo-removebg-preview.png" : "assets/klone_db_photos/klone-db-logo-removebg-preview.png"} alt="logo" style={{ height: "50px" }} />
                <span style={{ textDecoration: "!important none", cursor: "auto", color: "var(--primary-color)", fontWeight: "700" }}>Klone DB</span>
            </Link>
