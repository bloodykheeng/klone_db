...
//Auth two
import LoginPage from "./views/Auth-two/LoginPage";
import ResetPasswordPage from "./views/Auth-two/ResetPasswordPage";
import SignUpPage from "./views/Auth-two/SignUpPage";
